...
{
    public partial class ChangePasswordSeller : Form
    {
        int ID;
        Controller Control;
        bool Flag1, Flag2, Flag3;
        public ChangePasswordSeller()
        {
        ...
        private void ChangePasswordSeller_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                result = Control.ChangePasswordSeller(textBox1.Text, textBox2.Text, ID);
                if (result == 0)
                {
